...
expInfo = {
    'participant': '', 
    'session': '001'};
var person = prompt("Please enter your name", "test001");
...
function download_csv(num, cmplx) {
    var csv = 'Subject,Block,Trial No,Delta-f,Correct?,Reverse?\n';
